package csl.pay.thinkingInJava.generic.covariant.animal;
...
/**
 * 以加菲猫、猫、动物为例，说明<? extends T><? super T>
 */
...
public class AnimalCatGarfield {
    public static void main(String[] args) {
       ...
       // List<? extends Cat> extendsCatFromAnimal = animal;报错
       ...
       // List<? extends Cat>superCat=test;   List<?>不是List<? extends Cat>的父类或者子类
      //  List< ? super Cat>extendsCat=test;  List<?>不是List<? super Cat>的父类或者子类


        /**
         * 第三段：测试add方法，<? extends T>都无法进行add操作，<? super T>只能添加T或者T的子类集合
         */
