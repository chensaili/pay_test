package csl.pay.thinkingInJava.generic.covariant;//: generics/Wildcards.java
...
public class Wildcards {
  ...
  public static void main(String[] args) {
    ...
    //static <T> T exact2(Holder<T> holder, T arg) {
    // Long r5 = exact2(raw, lng); // Warnings:Unchecked conversion from Holder to Holder<Long>Unchecked method invocation: exact2(Holder<T>,T)is applied to (Holder,Long)
    Long r6 = exact2(qualified, lng);
    // Long r7 = exact2(unbounded, lng); // Error:exact2(Holder<T>,T) cannot be applied to(Holder<capture of ?>,Long)
    // Long r8 = exact2(bounded, lng); // Error:exact2(Holder<T>,T) cannot be appliedto (Holder<capture of ? extends Long>,Long)
    ...
    //static <T>void wildSupertype(Holder<? super T> holder, T arg) {
    // wildSupertype(raw, lng); // Warnings:Unchecked conversion from Holder to Holder<? super Long>Unchecked method invocation:wildSupertype(Holder<? super T>,T) is applied to (Holder,Long)
